...
const CARDAPIO_SIMOESFILHO_URL = 'https://app.cardapioweb.com/acai_parabrasil'

function CardapioSimoesfilho() {
  ...
  useEffect(() => {
    if (window.fbq) {
      window.fbq('track', 'ViewContent', {
        content_name: 'Cardápio Simões Filho - ParáBrasil',
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-deep-black">
      ...
      <div className="relative z-10 flex min-h-0 flex-col items-center justify-start gap-3 px-4 pt-20 pb-4 sm:min-h-screen sm:justify-center sm:gap-8 sm:py-12 sm:pt-24">
        ...
        >
          Simões Filho – Coroa da Lagoa. Oferta válida enquanto durarem os estoques.
        </motion.p>
      </div>
    </div>
  )
...
export default CardapioSimoesfilho
